      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold bg-gradient-to-r from-[#ff6b9d] to-[#9c27b0] bg-clip-text text-transparent">
              HellowShop
            </span>
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {categories.map((cat) => (
              <Link
                key={cat.id}
                href={`#${cat.id}`}
                className="text-gray-700 dark:text-gray-300 hover:text-[#ff6b9d] transition-colors font-medium"
              >
                {cat.name}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Cart */}
            <button className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 relative" aria-label="장바구니">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* User */}
            <button className="hidden sm:block p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800" aria-label="마이페이지">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="pb-4">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-12 rounded-full border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 focus:outline-none focus:border-[#ff6b9d]"
              />
